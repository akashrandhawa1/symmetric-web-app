...
export default function PlanRightSpineDemo() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4 md:p-6">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-white mb-2">Right Spine Plan View Demo</h1>
          <p className="text-sm text-zinc-400">
            Vertical spine on the right with aligned nodes showing readiness path (desktop only)
          </p>
        </div>
        <PlanViewWithRightSpine {...props} />
      </div>
    </div>
  );
}
